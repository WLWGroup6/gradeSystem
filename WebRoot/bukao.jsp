		...
		<div class="row-fluid">
			<div id = "left" class="span3 well">
				<div>
					...
					<form action = "Query_tbk" method = "POST">
						<table>
							<tr>
								<td>学年：
			...
			<div  class="span9 well">
				<div>
					...
					<table class="table table-hover table-bordered">
 						...
 						<tbody>
 							<c:forEach var="map1" items="${list}">
    							<tr>
    								<td><span class = "s_c_id">${map1.get('r_0')}</span><input type = "hidden" name = "s_c_id" value = "${map1.get('r_0')}"/></td>
									...
									<td>${map1.get('r_2')}</td>						
 									...
 									<td>${map1.get('r_4')}</td>
 									<td>${map1.get('r_5')}</td>
 									<td><input class="s_c_grade" style="width: 80px;height: 25px;" type = "text" name = "grade" value = "${map1.get('r_6')}"></td>
 								<td><input class="s_c_grade" style="width: 80px;height: 25px;" type = "text" name = "pgrade" value = "${map1.get('r_7')}"></td>
 								<td>${map1.get('r_8')}</td>
 								</tr>
    						</c:forEach>
